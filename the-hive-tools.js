...
(function() {
    ...
    if (true) {
       ...
       var dialog_css = '' +
        ...
        var css = dialog_css +
            'a.userLink .tht-highlight { border: 1px solid #fff !important; padding: 2px 5px !important; display:inline-block; margin: 3px; }' +
            '';
    }
        ...
        users.forEach(
            function(item) {
                if (isUserOnWatchlist(item.innerText)) {
                    ...
                    font.style.backgroundColor = font.color;
